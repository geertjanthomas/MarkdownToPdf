...
public interface IMarkdownToPdf : IDisposable
{
    ...
    IMarkdownToPdf DefaultDpi(double dpi);
    ...
    IMarkdownToPdf RegisterLocalFont(string name, string regular, string bold = "", string italic = "", string boldItalic = "", string? folder = null);

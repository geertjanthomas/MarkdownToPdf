...
namespace MarkdownToPdf10.MigrDoc;
...
internal class FontResolver : IFontResolver
{
    ...
    public FontResolverInfo ResolveTypeface(string familyName, bool isBold, bool isItalic)
    {
        ...
        {
            var x = PlatformFontResolver.ResolveTypeface(familyName, isBold, isItalic);
            var arial = PlatformFontResolver.ResolveTypeface("Arial", false, false);
            return x;
        }
